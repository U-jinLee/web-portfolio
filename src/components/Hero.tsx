    ...
    <section id="home" className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="container mx-auto max-w-4xl">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="space-y-6 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-foreground leading-relaxed max-w-2xl text-left">
              ...
              <br />백엔드를 바탕으로 AI 엔지니어의 역량을 쌓으며 인프라와 프론트엔드까지 아우르는 <b>폭넓은 관점</b>을 갖췄고, 이를 바탕으로 기술을 비즈니스 가치로 전환하는 것에 집중합니다.
            </p>
        ...
        <div className="grid grid-cols-3 gap-6 pt-8">
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            <div className="text-3xl font-bold text-primary mb-2">8<span className="text-xl"> +</span></div>
